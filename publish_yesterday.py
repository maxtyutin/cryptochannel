...
def main():
    ...
    for i, item in enumerate(items):
        print(f"\n[{i+1}/{len(items)}] Публикуем: {item['title']}")
        ...
        # Пауза 8 секунд для защиты от лимитов Telegram (20 сообщений/мин) и Gemini (15 RPM)
        time.sleep(8)
        
    print(f"\nГотово! Успешно опубликовано {published_count} постов за вчерашний день.")
